	...
	/*public static void main(String arg[]) {
		{
			...
			HuffmanDecoder decoder = new HuffmanDecoder(test,2differenceDataUsed,1amplitudeValueMultiplier,19999,null);
			try {
			...
			decoder = new HuffmanDecoder(test,2differenceDataUsed,5amplitudeValueMultiplier,19999,null);
			try {
				short[] decompressedData = decoder.decode(nSamples);
				for (int i=0; i<nSamples; ++i) {
